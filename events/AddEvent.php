...
<body>
    ...
    ?>
        ...
        $(document).ready(function () {
            ...
            $('#add-event-form input:visible').on('blur', validateInput);
            ...
            let startVisibleSibling = $($('#start_time').siblings('input')[0]);
            let endVisibleSibling = $($('#end_time').siblings('input')[0]);
            startVisibleSibling.on('blur', handleLastDay);
            endVisibleSibling.on('blur', handleLastDay);
            $('#add-event-form textarea').on('blur', validateInput);
        })
        ...
        function checkAllFields(){
            let isValid = true;
            $('#add-event-form input:visible').each(function(){
              $(this).trigger('blur');
            });

            $('#add-event-form textarea:visible').each(function(){
                $(this).trigger('blur');
            });
            ...
            if(!isValid){
                $('html, body').animate({
                    scrollTop: $('#add-event-form .is-invalid').first().offset().top
            }, 500);
            }
    ...
    <div class="container-fluid">
        ...
        <form class="form-group" method="post" action="/ubspectrum/events/insertEvent.php"
            enctype="multipart/form-data" id="add-event-form" onsubmit="return checkAllFields();">
            <div class="row mb-3">
                <div class="col-xs-12 col-md-4 text-md-right">
            ...
            <div class="row mb-3">
                ...
                <div class="col-xs-12 col-md-3 col-lg-2">
                    ...
                    <div class="invalid-feedback">
                        Please make sure the event ends after it starts.
                    </div>
                </div>
            </div>
            <div style="margin-left:33%;" class="row mb-3" id="recurring">
                <div class="col-xs-3">
            ...
            <div class="row  mb-3">
                ...
                <div class="col-xs-3">
                    ...
                    <button class="btn btn-primary" onclick="javascript:checkAllFields();" type="submit">Submit</button>
                </div>
            </div>
        </form>
